    ...
    <div className="min-h-screen bg-cream">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-earth mb-8">利用規約</h1>
          
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <section className="mb-8">
              <p className="mb-4">
                この利用規約（以下「本規約」といいます）は、シェアラビ運営事務局（以下「当サイト」といいます）がこのウェブサイト上で提供するサービス（以下「本サービス」といいます）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます）には、本規約に従って、本サービスをご利用いただきます。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>以下の内容を含む情報を本サービス上に投稿し、または送信する行為
                  <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                    <li>過度に暴力的な表現</li>
                    <li>露骨な性的表現</li>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2">
                <li>ユーザーが本サービスに投稿または送信するコンテンツ（文章、画像、動画その他のデータを含みますがこれらに限りません。以下「投稿コンテンツ」といいます）に関する著作権は、ユーザーに帰属します。</li>
                <li>ユーザーは、投稿コンテンツについて、当サイトに対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、配布、派生著作物の作成、表示および実行に関するライセンスを付与します。ユーザーは、他のユーザーに対しても、本サービスを利用してユーザーが投稿その他送信した投稿コンテンツの使用、複製、配布、派生著作物を作成、表示および実行することについての非独占的なライセンスを付与します。</li>
                <li>ユーザーは、当サイトおよび当サイトから権利を承継しまたは許諾された者に対して著作者人格権を行使しないことに同意するものとします。</li>
              </ol>
            </section>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2">
                <li>当サイトは、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、投稿データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。
                  <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
